...
public class CollectionUtils extends org.apache.commons.collections.CollectionUtils
{
    ...
    /**
     * Return an index between <code>0</code> and <code>l.size()</code> inclusive. If
     * <code>i</code> is negative, it is added to <code>l.size()</code> (but bounded to 0), ie
     * for a list of 3 items, -1 is the index of the last item ; -3 and -4 are both the first. If
     * <code>i</code> is greater than <code>l.size()</code> then <code>l.size()</code> is
     * returned.
     * 
     * <pre>
     *    a  b  c  a  b  c
     ...
     * @param transf how items of <code>a</code> should be transformed before being compared, can
     *        be <code>null</code>.
     * @return the number of common items, eg 1.
     */
