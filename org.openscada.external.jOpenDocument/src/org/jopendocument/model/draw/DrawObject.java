...
public class DrawObject {
    ...
    public String getDrawNotifyOnUpdateOfRanges() {
        return this.drawNotifyOnUpdateOfRanges;
    }
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the officeDocumentOrMathMath property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
    ...
    public List<Object> getOfficeDocumentOrMathMath() {
        if (this.officeDocumentOrMathMath == null) {
            this.officeDocumentOrMathMath = new ArrayList<Object>();
        }
        return this.officeDocumentOrMathMath;
    }
     ...
     * 
     */
    public void setDrawNotifyOnUpdateOfRanges(final String value) {
        this.drawNotifyOnUpdateOfRanges = value;
    }
